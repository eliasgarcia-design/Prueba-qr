...
try:
    ...
    if id_empleado:
        ...
        if not resultado.empty:
            ...
            # --- Lógica de la Laptop ---
            codigos_laptop = ["E08608", "E05695", "E05049", "E04292", "E06497", "E07746", "E03384", "E01169", "E09134", "E06852", "E02827","E06405"] # Pon aquí tus códigos reales
            
            st.markdown("---")
            st.markdown(f"### Hola, {nombre}")
            
            if id_empleado in codigos_laptop:
                st.info(f"Tu mesa asignada es la **{mesa}**. Has sido seleccionado para **llevar tu computadora** al debate.")
            else:
